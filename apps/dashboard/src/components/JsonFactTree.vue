...
import { factClassLabel, factClassProvenance, isFactClass } from '@/lib/reports'
...
<template>
  ...
  <article v-else-if="factClass" class="json-card" :data-prov="mappedProvenance ?? undefined">
    <header class="intel-top">
      <ProvenanceBadge v-if="mappedProvenance" :provenance="mappedProvenance" />
